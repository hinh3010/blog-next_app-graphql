...
const PostCard = ({ post }) => {
    return <div className="bg-white shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8">
        <div className="relative overflow-hidden shadow-md pb-80 mb-6">
            <img src={post.featuredImage?.url || 'https://bom.so/MDqCSY'}
                alt=""
        ...
        <div className="block lg:flex text-center items-center justify-center mb-8 w-full">
            <div className="flex items-center justify-center mb-4 lg:mb-0 w-full lg:w-auto mr-8">
                <img
                    ...
                    className="align-middle rounded-full object-cover w-8 h-8"
                    src={post.author.photo?.url || 'https://bom.so/MDqCSY'}
                />
